package com.wompking.mod_simply.mbe01_block_simple;
...
public class StartupClientOnly {
    public static void preInitClientOnly() {
        ...
        ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("mod_simply:mbe01_block_simple", "inventory");
