...
/*
   ...
   public class StartupCommon {
    ...
    java.lang.NoClassDefFoundError: net/minecraft/client/renderer/tileentity/TileEntitySpecialRenderer
  	at mod_simply.CommonProxy.preInit(CommonProxy.java:25) ~[CommonProxy.class:?]
...
@Mod(modid = ModSimply.MODID, version = ModSimply.VERSION)
//        guiFactory= ModSimply.GUIFACTORY)  //delete guiFactory if MBE70 not present and you don't have a configuration GUI
public class ModSimply {
    ...
    public static final String MODID = "mod_simply";
    public static final String VERSION = "1.0.0";

//    public static final String GUIFACTORY = "com.wompking.mod_simply.mbe70_configuration.MBEGuiFactory"; //delete if MBE70 not present

    // The instance of your mod that Forge uses.  Optional.
    @Mod.Instance(ModSimply.MODID)
    public static ModSimply instance;

    // Says where the client and server 'proxy' code is loaded.
    @SidedProxy(clientSide="com.wompking.mod_simply.ClientOnlyProxy", serverSide="com.wompking.mod_simply.DedicatedServerProxy")
     ...
     * @param name
     * @return eg "mod_simply:myblockname"
     */
